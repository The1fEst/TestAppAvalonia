...
namespace TestApp.Models {
    ...
    public class ItemSpec {
        ...
        [JsonPropertyName("items_in_set")] public List<ItemsInSet> ItemsInSet { get; set; }
    }
    ...
    public class ItemsInSet {
        ...
        [JsonPropertyName("mod_max_rank")] public long ModMaxRank { get; set; }

        [JsonPropertyName("trading_tax")] public long TradingTax { get; set; }

        [JsonPropertyName("url_name")] public string UrlName { get; set; }

        [JsonPropertyName("sub_icon")] public string SubIcon { get; set; }

        [JsonPropertyName("icon_format")] public string IconFormat { get; set; }
        ...
        [JsonPropertyName("zh-hant")] public Language ZhHant { get; set; }

        [JsonPropertyName("zh-hans")] public Language ZhHans { get; set; }
    ...
    public class Language {
        ...
        [JsonPropertyName("wiki_link")] public Uri WikiLink { get; set; }
